"""
Django settings for zoolander project.
...
INSTALLED_APPS = [
    'main_app',
    # 'zoolander.apps.ZoolanderConfig',
...
WSGI_APPLICATION = 'zoolander.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'zoolander',
        'USER': 'joshuaawynn',  # Your PostgreSQL username
